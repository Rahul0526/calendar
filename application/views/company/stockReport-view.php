...
<div class="content-wrapper">
  ...
  <section class="content">
      <div class="row">
        <div class="col-xs-80 ">
          <div class="box">
            <div class="box-header"><?php //site_url('ImportCSV/importStockReport')?>
              <h3 class="box-title">Stock Status Data List</h3>
            ...
            <!-- /.box-header -->
            <div class="box-body">
             <input type="hidden" id="req_url" value="<?php echo site_url('ImportCSV/getAjaxData/stock_report')?>" />
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
       ...
       <form action="<?=site_url('ImportCSV/importStockReport')?>" method="post">
