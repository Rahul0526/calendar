        ...
        <div class="col-xs-80 ">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Quarterly Change Data List</h3>
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <input type="hidden" id="req_url" value="<?php echo site_url('ImportCSV/getAjaxData/quarterly_change')?>" />
              <table  class="table table-bordered table-hover largeData">
                ...
                <tr>
                  ...
                  <th>Ticker</th>
                  <th>Date</th>
                  <th>Quarter_End_Adj_Close</th>
                  <th>Quarter_Start_Open</th>
                  <th>Price_Change_Quarter</th>
                   <th>Percent_Change_Quarter</th>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
       ...
       <form action="<?=site_url('ImportCSV/importQuarterlyChange')?>" method="post">
