        ...
        <div class="col-xs-80 ">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Weekly Change Data List</h3>
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <input type="hidden" id="req_url" value="<?php echo site_url('ImportCSV/getAjaxData/weekly_change')?>" />
              <table  class="table table-bordered table-hover largeData" data-url="">
                ...
                <tr>
                  ...
                  <th>Ticker</th>
                  <th>Date</th>
                  <th>Week_End_Adj_Close</th>
                  <th>Week_Start_Open</th>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
       ...
       <form action="<?=site_url('ImportCSV/importWeeklyChange')?>" method="post">
