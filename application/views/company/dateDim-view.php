        ...
        <div class="col-xs-80 ">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">ate Dim Data List</h3>
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <input type="hidden" id="req_url" value="<?php echo site_url('ImportCSV/getAjaxData/date_dim')?>" />
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
       ...
       <form action="<?=site_url('ImportCSV/importDataDim')?>" method="post">
