...
<section>
  <div class="container">
    ...
    <div class="row" style="margin-top:20px">
      <div class="col-xs-80 col-sm-60 col-md-40 col-centered Registation_Box">
        <div class="col-xs-70 col-centered Registation_Box1">
        <br>
        ...
        $('.alert').fadeOut('slow');
              ...
              <div class="row"> <a href="" class="btn btn-link pull-right" data-toggle="modal" data-target="#fpModal">Forgot Password?</a> </div>
              <hr class="colorgraph">
              <div class="row">
                ...
                <div class="col-xs-40 col-sm-40 col-md-40"> 
                <a href="<?=site_url('plan')?>" class="btn btn-lg btn-block btn-info">Register</a> </div>
              </div>
            </fieldset>
          </form>
          <br>
