          ...
          <form class="form-horizontal" action="<?=site_url('plans/editPlan/').$planInfo->id?>" method="post">
            <div class="box-body">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-40">
                   <?php echo form_textarea( array( 'name' => 'description','id'=>'description', 'class'=>"form-control", 'rows' => '5', 'cols' => '80', 'value' => $planInfo->description ) )?>
                     <?php echo form_error('description'); ?>
                  </div>
                </div>
              <div class="form-group">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-40">
                  <input id="trail" name="trail" type="checkbox" class="" value="1" <?php echo ($planInfo->trail==1)?"checked":'' ?> />
