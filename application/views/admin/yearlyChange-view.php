        ...
        <div class="col-xs-80 ">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Yearly Change Data List</h3>
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <input type="hidden" id="req_url" value="<?php echo site_url('ImportCSV/getAjaxData/yearly_change')?>" />
              <table  class="table table-bordered table-hover largeData" data-url="">
                ...
                <tr>
                  ...
                  <th>Ticker</th>
                  <th>Date</th>
                  <th>Year_End_Adj_Close</th>
                  <th>Year_Start_Open</th>
                  <th>Price_Change_Year</th>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
       ...
       <form action="<?=site_url('ImportCSV/importYearlyChange')?>" method="post">
