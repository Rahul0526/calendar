        ...
        <div class="col-xs-80 ">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Daily Change Data List</h3>
            ...
            <!-- /.box-header -->
            <div class="box-body">
             <input type="hidden" id="req_url" value="<?php echo site_url('ImportCSV/getAjaxData/daily_change')?>" />
              <table  class="table table-bordered table-hover largeData" data-url="">
                ...
                <tr>
                  ...
                  <th>Price_Change_Day</th>
                  <th>Percent_Change_Day</th>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
       ...
       <form action="<?=site_url('ImportCSV/importDailyChange')?>" method="post">
