        ...
        <div class="col-xs-80 ">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Stock  Data List</h3>
              <a href="" class="btn btn-flat  btn-circle pull-right" data-toggle="modal" data-target="#myModal"><i class="fa fa-upload fa-3x"></i></a>
              <span class="text-sm pull-right text-muted">Uploaded  Size- <?php echo round($fileInfo[0]->file_size/1024,2);?>kb</span><br/>
              <span class="text-sm pull-right text-muted">CSV Size- <?php echo round($csvInfo['size']/1024,2);?>kb</span><br/>
            ...
            <!-- /.box-header -->
            <div class="box-body">
             <input type="hidden" id="req_url" value="<?php echo site_url('ImportCSV/getAjaxData/stock')?>" />
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
       ...
       <form action="<?=site_url('ImportCSV/importStock')?>" method="post">
